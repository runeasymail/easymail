...
# Easy way to install
```
docker run -itd -p=110:110 -p=25:25 -p=995:995 -p=80:80 -p=443:443 -p=587:587 -p=993:993 -p=143:143 -p=465:465 -h "YOUR_DOMAIN_NAME" --name="easymail" easymail/easymail:v1.0.8 /bin/sh -c "bash /opt/easymail/post_install.sh; exec /bin/bash"
```
