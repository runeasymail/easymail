...
ALTER USER '$ROOT_MYSQL_USERNAME'@'localhost' IDENTIFIED BY '$ROOT_MYSQL_PASSWORD';
ALTER USER '$MYSQL_USERNAME'@'localhost' IDENTIFIED BY '$MYSQL_PASSWORD';
ALTER USER '$ROUNDCUBE_MYSQL_USERNAME'@'localhost' IDENTIFIED BY '$ROUNDCUBE_MYSQL_PASSWORD';

#ALTER USER '$ROOT_MYSQL_USERNAME'@'localhost' IDENTIFIED WITH mysql_native_password BY '$ROOT_MYSQL_PASSWORD';
#ALTER USER '$MYSQL_USERNAME'@'localhost' IDENTIFIED WITH mysql_native_password BY '$MYSQL_PASSWORD';
#ALTER USER '$ROUNDCUBE_MYSQL_USERNAME'@'localhost' IDENTIFIED WITH mysql_native_password BY '$ROUNDCUBE_MYSQL_PASSWORD';
